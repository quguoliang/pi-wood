...
import {
  ...
  Folder, FolderOpen, GitBranch, GitFork, Globe, Image, Keyboard, LayoutPanelLeft, ListChecks, ListTree, Loader2, MessageSquare, Package, PanelLeft, PanelRight, PanelTop, Paperclip, Play, Plus, RotateCw, Search, Settings, Shield, Terminal, Wrench, X,
} from "lucide-react";
...
const icons: Record<IconName, LucideIcon> = {
  activity: Activity, add: Plus, arrowLeft: ArrowLeft, arrowRight: ArrowRight, arrowUp: ArrowUp, at: AtSign, brain: Brain, browser: Globe, check: Check, circle: Circle, chevronDown: ChevronDown, cpu: Cpu, gitBranch: GitBranch, gitFork: GitFork, listChecks: ListChecks, listTree: ListTree, refresh: RotateCw, spinner: Loader2, wrench: Wrench,
