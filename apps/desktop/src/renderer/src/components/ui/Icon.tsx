...
import {
  ...
  Folder, FolderOpen, GitBranch, GitFork, Globe, Image, Keyboard, LayoutPanelLeft, ListChecks, ListTree, Loader2, MessageSquare, Package, PanelRight, PanelTop, Paperclip, Play, Plus, RotateCw, Search, Settings, Shield, Terminal, Wrench, X,
} from "lucide-react";
